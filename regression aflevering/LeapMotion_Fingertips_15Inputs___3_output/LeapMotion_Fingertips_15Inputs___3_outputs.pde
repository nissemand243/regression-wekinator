...
void draw() {
  background(myHue, myHue2, myHue3);
  // ...
...
void oscEvent(OscMessage theOscMessage) {
 if (theOscMessage.checkAddrPattern("/wek/outputs")==true) {
     if(theOscMessage.checkTypetag("fff")) { // looking for 1 control value
        float receivedHue = theOscMessage.get(0).floatValue();
        myHue = map(receivedHue, 0, 1, 50, 255);
        float receivedHue2 = theOscMessage.get(1).floatValue();
        myHue2 = map(receivedHue2, 0, 1, 50, 255);
        float receivedHue3 = theOscMessage.get(2).floatValue();
        myHue3 = map(receivedHue3, 0, 1, 50, 255);
     } else {
